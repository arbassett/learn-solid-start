...
export type ServerFunction<E extends any[], T extends (...args: [...E]) => void> = ((...p: Parameters<T>) => Promise<Awaited<ReturnType<T>>>) & {
    url: string;
};
export type CreateServerFunction = (<E extends any[], T extends (...args: [...E]) => void>(fn: T) => ServerFunction<E, T>) & {
